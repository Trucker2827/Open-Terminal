#!/usr/bin/env bash
# Copy the repo's openmarketterminal-qt/scripts/ tree to a target directory, excluding
...
#
# Exclusions (kept in sync with openmarketterminal-qt/cmake/prune_scripts_junk.cmake
