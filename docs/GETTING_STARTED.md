# Getting Started with Open Terminal Development
## Your Complete Onboarding Guide

Welcome to Open Terminal! This guide will get you from zero to your first contribution.

---

## What is Open Terminal?

Open Terminal is an **open-source financial analysis platform** — a free, open-source alternative to legacy professional financial terminals. Version 4 is a native C++20 application built with Qt6.
...
.\build\win-release\Open Terminal.exe
```
...
./build/linux-release/Open Terminal
```
...
./build/macos-release/Open Terminal.app/Contents/MacOS/Open Terminal
```
...
Open Terminal/
│
├── openmarketterminal-qt/                     ← Main application (you'll work here)
│   ├── src/                        ← C++ source code
...
```bash
cd openmarketterminal-qt/scripts
...
| Channel | Link |
|---------|------|
| GitHub Issues | https://github.com/your-org/open-terminal/issues |
| GitHub Discussions | https://github.com/your-org/open-terminal/discussions |
...
**Ready to contribute?**
- Pick an issue: https://github.com/your-org/open-terminal/issues
- Read the C++ guide: [openmarketterminal-qt/CONTRIBUTING.md](../openmarketterminal-qt/CONTRIBUTING.md)
