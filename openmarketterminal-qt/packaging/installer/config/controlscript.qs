// controlscript.qs — OpenMarketTerminal QtIFW Controller script.
//
// Wizard-page automation for HEADLESS / COMMAND-LINE invocations only, e.g.
//   OpenMarketTerminalMaintenanceTool.exe purge --confirm-command --accept-messages --default-answer
//   OpenMarketTerminal-<v>-setup.exe install --confirm-command --default-answer
