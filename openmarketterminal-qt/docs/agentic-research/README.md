# Agentic System Research — OpenMarketTerminal

This directory contains the research and design output for upgrading OpenMarketTerminal from a tool-using chatbot into a **true agentic system** capable of long-running autonomous tasks (e.g., "research company X for the next hour and write a report").
