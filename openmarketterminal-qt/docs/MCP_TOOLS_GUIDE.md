...
inside OpenMarketTerminal after the 6-phase refactor (see
`openmarketterminal-qt/plans/mcp-refactor-INDEX.md`).
...
- Refactor plans: `openmarketterminal-qt/plans/mcp-refactor-phase-{1..6}-*.md`
- Refactor index: `openmarketterminal-qt/plans/mcp-refactor-INDEX.md`
- Datahub: `openmarketterminal-qt/DATAHUB_ARCHITECTURE.md`
- Hub topics: `openmarketterminal-qt/docs/DATAHUB_TOPICS.md`
- Project rules: `openmarketterminal-qt/CLAUDE.md`
