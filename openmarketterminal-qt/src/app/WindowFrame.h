...
class WindowFrame : public QMainWindow {
  ...
  public:
    ...
    /// Lazily constructed on first invocation. OpenMarketTerminal-style "just type"
  ...
  private:
    ...
    /// LOCAL-FIRST FORK: boot directly into the local shell (no OpenMarketTerminal login).
