...
QString DockScreenRouter::title_for_id(const QString& id) {
    ...
    static const QHash<QString, const char*> titles = {
        ...
        {"backtesting", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Strategy Lab")},
        {"portfolio", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Portfolio")},
        {"watchlist", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Watchlist")},
        {"news", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "News")},
        {"ai_chat", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "AI Chat")},
        ...
        {"asia_markets", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Asia Markets")},
        ...
        {"ma_analytics", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "M&A Analytics")},
        {"surface_analytics", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Surface Analytics")},
        {"research_sources", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Research Sources")},
        {"quantlib", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Pricing Lab")},
        {"ai_quant_lab", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Quant Lab")},
        {"alpha_arena", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Alpha Arena")},
        {"tools_health", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Tools Health")},
        ...
        {"data_sources", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Data Sources")},
        {"data_mapping", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Data Mapping")},
        {"file_manager", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "File Manager")},
        {"notes", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Notes")},
        ...
        {"institution_holdings", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Institutions")},
        {"politician_trades", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Politicians")},
        ...
        {"terms", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Terms")},
        {"privacy", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Privacy")},
        {"trademarks", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Trademarks")},
        {"help", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Help")},
    };
    auto it = titles.find(id);
    if (it == titles.end())
        return id;
    return QCoreApplication::translate("openmarketterminal::DockScreenRouter", it.value());
}
