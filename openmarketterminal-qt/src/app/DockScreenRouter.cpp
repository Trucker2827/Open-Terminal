...
QString DockScreenRouter::title_for_id(const QString& id) {
    ...
    static const QHash<QString, const char*> titles = {
        ...
        {"algo_trading", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Algo Trading")},
        {"backtesting", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Backtesting")},
        ...
        {"quantlib", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "QuantLib")},
        {"ai_quant_lab", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "AI Quant Lab")},
        ...
        {"node_editor", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Node Editor")},
        {"code_editor", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Code Editor")},
        ...
        {"trade_viz", QT_TRANSLATE_NOOP("openmarketterminal::DockScreenRouter", "Trade Viz")},
