...
// This is NOT a openmarketterminal.db migration — it runs against cache.db directly.
...
Result<void> apply_v015(QSqlDatabase& /*db*/) {
    // This migration runs its DDL on cache.db, not openmarketterminal.db.
    // The version record is still tracked in openmarketterminal.db schema_version
