...
using openmarketterminal::services::algo::algo_indicators;
using openmarketterminal::services::algo::IndicatorDef;
using openmarketterminal::services::algo::ParamSpec;
