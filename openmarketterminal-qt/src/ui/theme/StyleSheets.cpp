...
namespace openmarketterminal::ui::styles {
...
QString crypto_trading_styles() {
    return QString(
               ...
               "  padding: 5px 0; font-size: 11px; font-weight: 700; letter-spacing: 0.6px; "
               ...
               "  letter-spacing: 0.3px; padding: 0 5px; }"
               ...
               "  color: %4; padding: 4px 8px; font-size: 11px; font-weight: 700; "
               "  selection-background-color: %13; }"
