...
void CommandBar::build_commands() {
    commands_ = {
        ...
        {"code_editor",
         tr("Notebooks"),
         "Research notebooks with a persistent Python kernel",
         {"code", "editor", "dev", "notebook", "notebooks"},
         "",
