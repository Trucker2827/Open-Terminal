...
void CommandBar::build_commands() {
    commands_ = {
        ...
        {"bitcoin",
         tr("Bitcoin"),
         "BTC-only live tape, bid/ask book, candles, and paper trading",
         {"btc", "xbt", "bitcoin", "satoshi"},
         "F9",
         {"bitcoin", "btc", "xbt", "order book", "tape"}},
        ...
        {"crypto_trading",
         ...
         {"crypto", "altcoins", "kraken"},
         "",
         {"trading", "crypto", "exchange", "altcoins"}},
        {"algo_trading",
         tr("Strategies"),
