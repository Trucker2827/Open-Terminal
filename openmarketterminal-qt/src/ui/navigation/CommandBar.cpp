...
using openmarketterminal::ui::commandbar_internal::kMaxResults;
...
void CommandBar::build_commands() {
    commands_ = {
        ...
        {"backtesting",
         tr("Strategy Lab"),
         "Advanced strategy backtesting and provider comparison",
         {"bktest", "backtest", "bt", "strategy lab"},
         "F5",
        ...
        {"crypto_trading",
         tr("Crypto Trading"),
         "Trade spot crypto (Coinbase/Kraken) — book, ticket, fees; not Kalshi bets",
         {"crypto", "altcoins", "kraken", "btc", "xbt", "bitcoin", "satoshi"},
         "",
         {"trading", "crypto", "exchange", "altcoins", "bitcoin", "btc", "order book", "tape"}},
        {"algo_trading",
         tr("Strategies"),
         "Paper proof sandbox: evidence books, handlers, risk gates — not Kalshi live arm",
         {"algo", "algotrading", "strategies", "strategy"},
         "",
         {"algo", "algorithmic", "automated", "paper", "sandbox"}},
        {"alpha_arena",
         tr("Alpha Arena"),
        ...
        {"polymarket",
         ...
         "Kalshi + Polymarket races/bets; live Kalshi arm and bot cockpit live here",
         {"poly", "polymarket", "kalshi", "prediction"},
         "",
         {"polymarket", "kalshi", "prediction", "markets"}},
        {"edge_radar",
         tr("Edge Radar"),
         "Local stock and prediction-market edge scoring",
         {"edge", "radar", "kalshi edge", "stock edge"},
         "",
         {"edge", "kalshi", "polymarket", "stocks", "probability"}},
        {"derivatives",
         tr("Derivatives"),
        ...
        {"research_sources",
         tr("Research Sources"),
         "Research feed provenance and source health",
         {"sources", "feeds", "sourcehealth", "researchhealth"},
         "",
         {"research", "sources", "feeds", "provenance", "health"}},
        // Economics & Data
        {"economics",
         tr("Economics"),
         "Economic indicators",
        ...
        {"weather",
         tr("Weather"),
         "Kalshi weather predictions (daily temps)",
         {"weather", "temperature", "climate"},
         "",
         {"weather", "temperature", "kalshi", "forecast"}},
        {"relationship_map",
         tr("Relationship Map"),
        ...
        {"ai_quant_lab",
         tr("Quant Lab"),
         "Experimental AI/ML quantitative research modules",
         {"quantlab", "quant", "lab", "ai quant"},
         "",
         {"quant", "quantitative", "lab"}},
        {"quantlib",
         tr("Pricing Lab"),
         "Local QuantLib pricing and quantitative finance tools",
         {"qlcore", "ql", "quantlib", "pricing lab"},
         "",
        ...
        {"node_editor",
         ...
         {"nodes", "workflow", "node", "automation"},
         "",
         {"nodes", "workflow", "visual"}},
        {"code_editor",
         tr("Research Lab"),
         "Research Lab: notebooks, experiments, reports, and a persistent Python kernel",
         {"code", "editor", "dev", "notebook", "notebooks", "research", "lab"},
         "",
         {"code", "editor", "programming", "research", "notebooks"}},
        {"excel",
         tr("Excel"),
        ...
        {"tools_health",
         tr("Tools Health"),
         "Audit tool coverage and CLI/MCP readiness",
         {"toolshealth", "toolstatus", "parity"},
         "",
         {"tools", "health", "coverage", "mcp", "cli"}},
        {"trade_viz",
         tr("Trade Intelligence"),
         "Live/fallback trade-flow map with market-impact hints",
         {"tradeviz", "tradegraph", "tradeintel", "tradeflows"},
         "",
         {"trade", "visualization", "flow", "intelligence", "comtrade", "supply chain"}},
        // Community / Info
        {"about",
         tr("About"),
         "About OpenMarketTerminal",
         {"about", "info", "version"},
         "",
