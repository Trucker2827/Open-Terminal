...
QString action_for_function_code(const QString& upper) {
    static const QHash<QString, QString> kCodes = {
        ...
        {QStringLiteral("BTC"), QStringLiteral("screen.crypto_trading")},
        {QStringLiteral("XBT"), QStringLiteral("screen.crypto_trading")},
        {QStringLiteral("BITCOIN"), QStringLiteral("screen.crypto_trading")},
