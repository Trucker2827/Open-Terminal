...
Q_DECLARE_METATYPE(openmarketterminal::WindowId)
Q_DECLARE_METATYPE(openmarketterminal::PanelInstanceId)
Q_DECLARE_METATYPE(openmarketterminal::LayoutId)
Q_DECLARE_METATYPE(openmarketterminal::ProfileId)
