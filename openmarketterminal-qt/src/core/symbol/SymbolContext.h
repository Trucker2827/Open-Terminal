...
class SymbolContext : public QObject {
  ...
  signals:
    ...
    void group_symbol_changed(openmarketterminal::SymbolGroup g, openmarketterminal::SymbolRef ref, QObject* source);
    ...
    void group_slot_symbol_changed(openmarketterminal::SymbolGroup g, QString slot,
                                   openmarketterminal::SymbolRef ref, QObject* source);

    void active_symbol_changed(openmarketterminal::SymbolRef ref, QObject* source);
