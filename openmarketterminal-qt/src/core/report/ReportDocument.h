...
namespace openmarketterminal::report {
...
struct ReportMetadata {
    ...
    QString company = "Open Terminal contributors";
    QString date;
    QString header_left;
...
inline ReportTheme openmarketterminal_terminal() {
    return {"OpenMarketTerminal",
...
inline ReportTheme by_name(const QString& name) {
    ...
    if (name == "OpenMarketTerminal")
        return openmarketterminal_terminal();
...
inline QStringList all_names() {
    return {"Light Professional", "Dark Corporate", "OpenMarketTerminal", "Midnight Blue"};
}
...
struct ReportDocument {
    ...
    static Result<ReportDocument> from_json_obj(const QJsonObject& root) {
        ...
        if (root.contains("metadata")) {
            ...
            out.metadata.company = m.value("company").toString("Open Terminal contributors");
