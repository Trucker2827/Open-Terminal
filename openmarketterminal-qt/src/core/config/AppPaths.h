...
///   Windows : %LOCALAPPDATA%/org.openterminal.OpenTerminal/
///   macOS   : ~/Library/Application Support/org.openterminal.OpenTerminal/
///   Linux   : ~/.local/share/org.openterminal.OpenTerminal/
///
/// Sub-directories:
///   data/    — SQLite databases (openmarketterminal.db, cache.db)
...
class AppPaths {
  public:
    /// Root: %LOCALAPPDATA%\org.openterminal.OpenTerminal  (Windows)
    static QString root();
