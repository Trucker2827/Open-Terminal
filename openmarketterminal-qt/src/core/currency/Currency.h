...
inline QString symbol() { return openmarketterminal::currency::CurrencyManager::instance().symbol(); }
...
inline QString symbol_for(const QString& code) {
    return openmarketterminal::currency::CurrencyManager::symbol_for(code);
}
...
inline QString money(double v, bool compact = false, const QString& intrinsic = QString()) {
    const QString sym = intrinsic.isEmpty()
                            ? symbol()
                            : openmarketterminal::currency::CurrencyManager::symbol_for(intrinsic);
...
inline void bindLabel(QLabel* lbl, const QString& tmpl) {
    ...
    QObject::connect(&openmarketterminal::currency::CurrencyManager::instance(),
                     &openmarketterminal::currency::CurrencyManager::currency_changed, lbl,
...
inline void bindPrefix(QAbstractSpinBox* spin) {
    ...
    apply(symbol());
    QObject::connect(&openmarketterminal::currency::CurrencyManager::instance(),
                     &openmarketterminal::currency::CurrencyManager::currency_changed, spin,
