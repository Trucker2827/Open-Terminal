...
//
// Translations are compiled from .ts files under openmarketterminal-qt/translations/ at
// build time (qt6_add_lrelease) and embedded in the Qt resource system at
// :/i18n/openmarketterminal_<locale>.qm. English is the source language — no .qm exists
...
namespace openmarketterminal::i18n {
