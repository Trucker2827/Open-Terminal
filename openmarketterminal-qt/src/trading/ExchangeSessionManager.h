...
// warm for the application lifetime (OpenMarketTerminal-style) — switching exchanges
...
class ExchangeSessionManager : public QObject, public openmarketterminal::datahub::Producer {
    Q_OBJECT
  public:
