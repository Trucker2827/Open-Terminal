...
void DataStreamManager::ensure_registered_with_hub() {
    ...
    openmarketterminal::datahub::TopicPolicy positions_policy;
    ...
    openmarketterminal::datahub::TopicPolicy orders_policy;
    ...
    openmarketterminal::datahub::TopicPolicy balance_policy;
    ...
    openmarketterminal::datahub::TopicPolicy ticks_policy;
    ...
    openmarketterminal::datahub::TopicPolicy holdings_policy;
    ...
    openmarketterminal::datahub::TopicPolicy quote_policy;
...
void DataStreamManager::on_positions_for_hub(const QString& account_id,
    ...
    openmarketterminal::datahub::DataHub::instance().publish(topic, QVariant::fromValue(positions));
}
...
void DataStreamManager::on_holdings_for_hub(const QString& account_id,
    ...
    openmarketterminal::datahub::DataHub::instance().publish(topic, QVariant::fromValue(holdings));
}
...
void DataStreamManager::on_orders_for_hub(const QString& account_id,
    ...
    openmarketterminal::datahub::DataHub::instance().publish(topic, QVariant::fromValue(orders));
}
...
void DataStreamManager::on_funds_for_hub(const QString& account_id, const BrokerFunds& funds) {
    ...
    openmarketterminal::datahub::DataHub::instance().publish(topic, QVariant::fromValue(funds));
}
...
void DataStreamManager::on_quote_for_hub(const QString& account_id, const QString& symbol,
    ...
    openmarketterminal::datahub::DataHub::instance().publish(topic, QVariant::fromValue(quote));
}
...
void DataStreamManager::open_quote_feed(QObject* owner, const QString& consumer_id,
    ...
    QMetaObject::invokeMethod(this, [this, guard, consumer_id, account_id, symbol, cb]() {
        ...
        if (auto old = quote_feeds_.find(consumer_id); old != quote_feeds_.end()) {
            if (old->owner)
                openmarketterminal::datahub::DataHub::instance().unsubscribe(old->owner, old->topic);
        ...
        openmarketterminal::datahub::DataHub::instance().subscribe<BrokerQuote>(
...
void DataStreamManager::close_quote_feed(const QString& consumer_id, const QString& account_id) {
    QMetaObject::invokeMethod(this, [this, consumer_id, account_id]() {
        if (auto it = quote_feeds_.find(consumer_id); it != quote_feeds_.end()) {
            if (it->owner)
                openmarketterminal::datahub::DataHub::instance().unsubscribe(it->owner, it->topic);
