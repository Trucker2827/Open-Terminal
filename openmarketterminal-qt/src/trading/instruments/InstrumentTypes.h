...
struct Instrument {
    ...
    QString broker_id; // "alpaca", "ibkr", etc.
    QString broker_token; // Native non-numeric instrument key for brokers that use
                          // string handles instead of numeric tokens. Empty for
                          // numeric-token brokers, which use instrument_token.
