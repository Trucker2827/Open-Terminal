...
openmarketterminal::Result<void> InstrumentRepository::replace_all(const QString& broker_id,
    ...
    return openmarketterminal::Result<void>::ok();
}

openmarketterminal::Result<void> InstrumentRepository::clear(const QString& broker_id) {
