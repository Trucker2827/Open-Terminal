...
AlpacaWebSocket::AlpacaWebSocket(const QString& api_key, const QString& api_secret,
    ...
    connect(ws_, &openmarketterminal::WebSocketClient::connected, this, &AlpacaWebSocket::on_ws_connected);
    connect(ws_, &openmarketterminal::WebSocketClient::disconnected, this, &AlpacaWebSocket::on_ws_disconnected);
    connect(ws_, &openmarketterminal::WebSocketClient::message_received, this, &AlpacaWebSocket::on_ws_message);
    connect(ws_, &openmarketterminal::WebSocketClient::error_occurred, this, &AlpacaWebSocket::on_ws_error);
