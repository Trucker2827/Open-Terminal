...
class AlpacaWebSocket : public QObject {
  ...
  signals:
    void tick_received(const openmarketterminal::trading::BrokerQuote& quote);
    void trade_received(const openmarketterminal::trading::BrokerTrade& trade);
    void bar_received(const QString& symbol, const openmarketterminal::trading::BrokerCandle& candle);
    void connected();
    void disconnected();
