...
#include <QMetaType>
Q_DECLARE_METATYPE(openmarketterminal::trading::BrokerPosition)
Q_DECLARE_METATYPE(openmarketterminal::trading::BrokerHolding)
Q_DECLARE_METATYPE(openmarketterminal::trading::BrokerOrderInfo)
Q_DECLARE_METATYPE(openmarketterminal::trading::BrokerQuote)
Q_DECLARE_METATYPE(openmarketterminal::trading::BrokerFunds)
Q_DECLARE_METATYPE(QVector<openmarketterminal::trading::BrokerPosition>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::trading::BrokerHolding>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::trading::BrokerOrderInfo>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::trading::BrokerQuote>)
