    ...
    , public openmarketterminal::datahub::Producer
{
  ...
  signals:
    void result_ready(const QString& request_id, const openmarketterminal::services::EconomicsResult& result);
...
#include <QMetaType>
Q_DECLARE_METATYPE(openmarketterminal::services::EconomicsResult)
