...
namespace openmarketterminal::services::options {
...
struct OptionChainRow {
    ...
    openmarketterminal::trading::BrokerQuote ce_quote;
    openmarketterminal::trading::BrokerQuote pe_quote;
...
struct OptionChain {
    QString broker_id;
    QString underlying;              // "SPX", "AAPL", "BTC", …
...
struct StrategyLeg {
    ...
    openmarketterminal::trading::InstrumentType type = openmarketterminal::trading::InstrumentType::UNKNOWN;
    double  strike = 0;
    QString expiry;
    int     lot_size = 0;
...
Q_DECLARE_METATYPE(openmarketterminal::services::options::OptionGreeks)
Q_DECLARE_METATYPE(openmarketterminal::services::options::OptionChainRow)
Q_DECLARE_METATYPE(openmarketterminal::services::options::OptionChain)
Q_DECLARE_METATYPE(openmarketterminal::services::options::StrategyLeg)
Q_DECLARE_METATYPE(openmarketterminal::services::options::Strategy)
Q_DECLARE_METATYPE(openmarketterminal::services::options::PayoffPoint)
Q_DECLARE_METATYPE(openmarketterminal::services::options::StrategyAnalytics)
Q_DECLARE_METATYPE(openmarketterminal::services::options::OISample)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::options::OptionChainRow>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::options::PayoffPoint>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::options::StrategyLeg>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::options::OISample>)
