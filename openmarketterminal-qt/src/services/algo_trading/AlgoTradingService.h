...
class AlgoTradingService : public QObject {
  ...
  public:
    ...
    void run_backtest(const openmarketterminal::services::algo::AlgoStrategy& strategy, const QString& symbol,
  ...
  signals:
    ...
    void strategies_loaded(QVector<openmarketterminal::services::algo::AlgoStrategy> strategies);
