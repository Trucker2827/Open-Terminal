...
struct AlgoStrategy {
    ...
    QJsonArray legs; // reserved; always empty (equity is single-symbol)
...
// US + global large caps (US-listed, incl. ADRs) — the default autocomplete
// universe for symbol pickers. The app targets US/EU/worldwide markets.
inline QStringList us_largecap_symbols() {
...
// US mega-cap tech — a common quick-add basket for scanners/alerts.
inline QStringList us_tech_symbols() {
