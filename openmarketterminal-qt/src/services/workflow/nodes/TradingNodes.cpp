        ...
        .parameters =
            {
                ...
                {"broker", "Broker", "select", "alpaca", {"alpaca", "ibkr", "tradier", "saxobank", "metatrader4"}, "Broker (live mode only)"},
                {"symbol", "Symbol", "string", "", {}, "Ticker symbol", true},
                {"exchange", "Exchange", "select", "NASDAQ", {"NASDAQ", "NYSE", "AMEX", "CBOE", "LSE", "TSX", "XETRA", "EURONEXT", "CRYPTO", "FOREX"}, ""},
        ...
        .parameters =
            {
                ...
                {"broker", "Broker", "select", "alpaca", {"alpaca", "ibkr", "tradier", "saxobank", "metatrader4"}, ""},
        ...
        .parameters =
            {
                ...
                {"symbol", "Symbol", "string", "", {}, "Ticker symbol", true},
                {"exchange", "Exchange", "select", "NASDAQ", {"NASDAQ", "NYSE", "AMEX", "CBOE", "LSE", "TSX", "XETRA", "EURONEXT", "CRYPTO", "FOREX"}, ""},
                {"product", "Product", "select", "", {"", "delivery", "intraday", "margin"}, "Optional product filter"},
            },
        .execute = nullptr,
    });
