...
void register_utility_tier1_extra(NodeRegistry& registry) {
    ...
    registry.register_type({
        ...
        .available = false,
        .unavailable_reason =
            "Unavailable: control.execute_workflow is not implemented yet. No workflow was executed.",
    });
    ...
    registry.register_type({
        ...
        .category = "Triggers",
        .description = "Trigger on market events (high volatility, circuit breaker, etc.). Manual run only — "
                       "scheduling is not wired. This node does not fire on a timer.",
        .icon_text = ">>",
        .accent_color = "#d97706",
        .version = 1,
        .inputs = {},
    ...
    registry.register_type({
        ...
        .available = false,
        .unavailable_reason =
            "Unavailable: transform.reshape has no real reshape implementation yet. No data was transformed.",
    });
