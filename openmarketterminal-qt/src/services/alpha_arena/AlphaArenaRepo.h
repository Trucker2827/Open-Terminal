...
//
// Unlike most openmarketterminal repos, this one is a *facade* — one class with methods
...
//
// Reference: openmarketterminal-qt/.grill-me/alpha-arena-production-refactor.md §Phase 4
