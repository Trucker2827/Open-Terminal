...
//
// Reference: openmarketterminal-qt/.grill-me/alpha-arena-grill.md §4 (Context builder)
...
class ModelDispatcher : public QObject {
  ...
  public slots:
    ...
    /// before this call.
    void dispatch_tick(openmarketterminal::services::alpha_arena::Tick t,
                       openmarketterminal::services::alpha_arena::TickContext ctx,
                       QHash<QString, openmarketterminal::services::alpha_arena::AgentAccountState> per_agent_state,
                       std::optional<openmarketterminal::services::alpha_arena::SituationalContext> situational);
