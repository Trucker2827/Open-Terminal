...
class EquityResearchService : public QObject {
  ...
  signals:
    void search_results_loaded(QVector<openmarketterminal::services::equity::SearchResult> results);
    void quote_loaded(openmarketterminal::services::equity::QuoteData quote);
    void info_loaded(openmarketterminal::services::equity::StockInfo info);
    void historical_loaded(QString symbol, QVector<openmarketterminal::services::equity::Candle> candles);
    void financials_loaded(openmarketterminal::services::equity::FinancialsData data);
    void technicals_loaded(openmarketterminal::services::equity::TechnicalsData data);
    void peers_loaded(QVector<openmarketterminal::services::equity::PeerData> peers);
    void news_loaded(QString symbol, QVector<openmarketterminal::services::equity::NewsArticle> articles);
  ...
  private:
    ...
    // OpenMarketTerminal-backend HttpClient singleton (which carries base-url/session token).
