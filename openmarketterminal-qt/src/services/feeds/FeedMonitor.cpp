...
FeedMonitor::FeedMonitor() : QObject(nullptr) {
    qRegisterMetaType<openmarketterminal::feeds::FeedItem>("openmarketterminal::feeds::FeedItem");
    qRegisterMetaType<QVector<openmarketterminal::feeds::FeedItem>>("QVector<openmarketterminal::feeds::FeedItem>");
    qRegisterMetaType<openmarketterminal::feeds::FeedStatus>("openmarketterminal::feeds::FeedStatus");
