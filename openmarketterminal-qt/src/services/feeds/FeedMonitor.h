...
class FeedMonitor : public QObject {
  ...
  signals:
    void feed_updated(const QString& feed_id, const QVector<openmarketterminal::feeds::FeedItem>& items);
    void feed_status(const QString& feed_id, openmarketterminal::feeds::FeedStatus status, const QString& msg);
