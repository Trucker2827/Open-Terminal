...
QString NotebookLibraryService::assets_dir() {
    ...
    const QStringList candidates = {
        ...
        exe + "/../../resources/notebooks",
        exe + "/../share/openmarketterminal/resources/notebooks", // Linux install
    };
    ...
    for (int i = 0; i < 8 && dir.cdUp(); ++i) {
        ...
        const QString p2 = dir.filePath("openmarketterminal-qt/resources/notebooks/notebooks_manifest.json");
...
QString NotebookLibraryService::seed_marker_path() const {
    return openmarketterminal::AppPaths::data() + "/.openmarketterminal_notebooks_seeded_v1";
}
