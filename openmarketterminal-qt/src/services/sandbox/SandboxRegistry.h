...
//
// This enumerates every competing lane. seed_default_strategies() activates
// only producer-backed lanes whose target clears the honest round-trip cost;
// deferred lanes remain visible here until their producers exist.
