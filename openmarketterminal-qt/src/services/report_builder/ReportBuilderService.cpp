...
ReportBuilderService::ReportBuilderService() {
    ...
    autosave_path_ =
        QStandardPaths::writableLocation(QStandardPaths::TempLocation) + "/openmarketterminal_report_autosave.openmarketterminal";
    ...
    QSettings s("Open Terminal", "Open Terminal");
