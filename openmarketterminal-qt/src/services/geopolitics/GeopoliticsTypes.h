...
//
// The OpenMarketTerminal API now wraps every events response with pagination and credit
...
#include <QMetaType>
Q_DECLARE_METATYPE(openmarketterminal::services::geo::NewsEvent)
Q_DECLARE_METATYPE(openmarketterminal::services::geo::HDXDataset)
Q_DECLARE_METATYPE(openmarketterminal::services::geo::UniqueCountry)
Q_DECLARE_METATYPE(openmarketterminal::services::geo::UniqueCategory)
Q_DECLARE_METATYPE(openmarketterminal::services::geo::EventsPage)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::geo::NewsEvent>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::geo::HDXDataset>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::geo::UniqueCountry>)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::geo::UniqueCategory>)
