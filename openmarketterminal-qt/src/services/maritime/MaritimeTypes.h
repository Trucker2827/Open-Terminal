...
#include <QMetaType>
Q_DECLARE_METATYPE(openmarketterminal::services::maritime::VesselData)
Q_DECLARE_METATYPE(openmarketterminal::services::maritime::VesselsPage)
Q_DECLARE_METATYPE(openmarketterminal::services::maritime::VesselHistoryPage)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::maritime::VesselData>)
