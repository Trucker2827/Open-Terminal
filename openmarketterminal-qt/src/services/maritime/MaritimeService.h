...
/// Singleton service for Maritime Intelligence — HTTP calls to api.example.com/marine/
    ...
    , public openmarketterminal::datahub::Producer
{
  ...
  signals:
    ...
    void vessels_loaded(openmarketterminal::services::maritime::VesselsPage page);
    void vessel_found(openmarketterminal::services::maritime::VesselData vessel);
    void vessel_history_loaded(openmarketterminal::services::maritime::VesselHistoryPage page);
