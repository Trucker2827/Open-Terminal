...
class PredictionExchangeAdapter : public QObject {
  ...
  signals:
    ...
    void search_results_ready(const QVector<openmarketterminal::services::prediction::PredictionMarket>& markets,
    ...
    void order_book_ready(const openmarketterminal::services::prediction::PredictionOrderBook& book);
    void price_history_ready(const openmarketterminal::services::prediction::PriceHistory& history);
    void recent_trades_ready(const QVector<openmarketterminal::services::prediction::PredictionTrade>& trades);
    ...
    void ws_orderbook_updated(const QString& asset_id, const openmarketterminal::services::prediction::PredictionOrderBook& book);
    void ws_connection_changed(bool connected);

    // Account / trading
    void credentials_changed();  // emitted when user adds/removes a credential set
    void balance_ready(const openmarketterminal::services::prediction::AccountBalance& balance);
    void positions_ready(const QVector<openmarketterminal::services::prediction::PredictionPosition>& positions);
    void open_orders_ready(const QVector<openmarketterminal::services::prediction::OpenOrder>& orders);
    void order_placed(const openmarketterminal::services::prediction::OrderResult& result);
