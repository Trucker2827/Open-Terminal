...
static openmarketterminal::screens::ReportTheme default_canvas_theme() {
...
static QString render_chart_to_file(const QString& chart_type, const QString& title, const QString& data_str,
    ...
    QString path = QStandardPaths::writableLocation(QStandardPaths::TempLocation) +
                   QString("/openmarketterminal_chart_%1.png").arg(QDateTime::currentMSecsSinceEpoch());
...
static QString render_sparkline_to_file(const QString& data_str, const ReportTheme& theme, int width = 200,
    ...
    QString path = QStandardPaths::writableLocation(QStandardPaths::TempLocation) +
                   QString("/openmarketterminal_spark_%1.png").arg(QDateTime::currentMSecsSinceEpoch());
    if (pix.save(path, "PNG"))
        return path;
    return {};
}
