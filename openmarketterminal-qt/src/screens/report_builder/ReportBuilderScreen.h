...
// recent files) lives in openmarketterminal::services::ReportBuilderService. This
...
// originally written against types declared inside openmarketterminal::screens. After
...
using ReportComponent = ::openmarketterminal::report::ReportComponent;
using ReportMetadata = ::openmarketterminal::report::ReportMetadata;
using ReportTheme = ::openmarketterminal::report::ReportTheme;
