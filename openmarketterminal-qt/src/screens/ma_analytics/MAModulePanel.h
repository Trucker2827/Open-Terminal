...
using openmarketterminal::services::ma::MAAnalyticsService;
...
class MAModulePanel : public QWidget {
    Q_OBJECT
  public:
    explicit MAModulePanel(const openmarketterminal::services::ma::ModuleInfo& info, QWidget* parent = nullptr);
  ...
  private:
    ...
    openmarketterminal::services::ma::ModuleInfo module_;
