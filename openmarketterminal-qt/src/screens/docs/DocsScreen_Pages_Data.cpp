...
QWidget* DocsScreen::page_profile() {
    return make_page(tr("PROFILE"), tr("User account, subscription, and usage tracking"),
                     {
                         {tr("OVERVIEW"), tr("The Profile screen displays your account information and "
                                             "security settings. OpenMarketTerminal is free and open-source — "
                                             "there are no plans, credits, or billing.")},
                         {tr("KEY FEATURES"), tr("■  Account details — Name, email, registration date\n"
                                                 "■  Security — Two-factor auth and email verification status\n"
                                                 "■  Support — Open and track help tickets")},
                         {tr("REAL-WORLD USAGE"), tr("■  Review and edit your account details\n"
                                                     "■  Enable two-factor authentication\n"
                                                     "■  Reach support when you need help")},
                         {tr("SKILL LEVELS"), tr("BEGINNER: Review your account details\n"
                                                 "INTERMEDIATE: Enable 2FA for stronger security\n"
                                                 "ADVANCED: Manage sessions and API keys\n"
                                                 "PRO: Script account actions via the MCP profile tools")},
                     });
}
