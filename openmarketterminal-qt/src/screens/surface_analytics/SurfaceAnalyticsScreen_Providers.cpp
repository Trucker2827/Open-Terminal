...
void SurfaceAnalyticsScreen::on_vol_surface_received(const openmarketterminal::DatabentoVolSurfaceResult& r) {
    if (data_inspector_)
...
void SurfaceAnalyticsScreen::on_ohlcv_received(const openmarketterminal::DatabentoOhlcvResult& r) {
    if (data_inspector_) {
...
void SurfaceAnalyticsScreen::on_futures_received(const openmarketterminal::DatabentoFuturesResult& r) {
    if (data_inspector_) {
...
void SurfaceAnalyticsScreen::on_surface_received(const openmarketterminal::DatabentoSurfaceResult& r) {
    if (data_inspector_) {
