...
namespace openmarketterminal::surface {
...
class SurfaceAnalyticsScreen : public QWidget,
                               public openmarketterminal::screens::IStatefulScreen,
                               public openmarketterminal::IGroupLinked {
    Q_OBJECT
  ...
  public:
    ...
    void set_group(openmarketterminal::SymbolGroup g) override { link_group_ = g; }
    openmarketterminal::SymbolGroup group() const override { return link_group_; }
    void on_group_symbol_changed(const openmarketterminal::SymbolRef& ref) override;
    openmarketterminal::SymbolRef current_symbol() const override;
  ...
  private slots:
    ...
    void on_vol_surface_received(const openmarketterminal::DatabentoVolSurfaceResult& r);
    void on_ohlcv_received(const openmarketterminal::DatabentoOhlcvResult& r);
    void on_futures_received(const openmarketterminal::DatabentoFuturesResult& r);
    void on_surface_received(const openmarketterminal::DatabentoSurfaceResult& r);
  ...
  private:
    ...
    openmarketterminal::SymbolGroup link_group_ = openmarketterminal::SymbolGroup::None;
