...
using namespace openmarketterminal::services::backtest;
using openmarketterminal::screens::backtesting_internal::pill_qss;
using openmarketterminal::screens::backtesting_internal::apply_pill_geometry;
