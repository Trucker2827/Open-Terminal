...
using openmarketterminal::services::alpha_arena::AgentSpec;
using openmarketterminal::services::alpha_arena::AlphaArenaEngine;
using openmarketterminal::services::alpha_arena::CompetitionMode;
using openmarketterminal::services::alpha_arena::NewCompetitionConfig;
using openmarketterminal::services::alpha_arena::kPerpUniverse;
...
void AlphaArenaScreen::on_live_mode_toggle_clicked() {
    ...
    if (!openmarketterminal::trading::hyperliquid::HyperliquidSigner::is_wired()) {
        QMessageBox::critical(this, tr("Alpha Arena"),
...
#ifndef OPENMARKETTERMINAL_UNSAFE_DISABLE_GEOFENCE
