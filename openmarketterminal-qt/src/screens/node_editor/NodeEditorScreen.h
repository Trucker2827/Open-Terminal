...
class NodeEditorScreen : public QWidget, public openmarketterminal::screens::IStatefulScreen {
    Q_OBJECT
  public:
...
namespace screens {
using NodeEditorScreen = openmarketterminal::workflow::NodeEditorScreen;
}
