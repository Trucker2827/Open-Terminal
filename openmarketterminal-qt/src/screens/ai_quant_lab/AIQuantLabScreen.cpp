...
QWidget* AIQuantLabScreen::build_right_sidebar() {
    ...
    // Stat labels stored as members so retranslateUi can reset them. Only
    // enumerable, backed numbers are shown: the live module count and the
    // 5 RL algorithms (PPO/DQN/A2C/SAC/TD3).
