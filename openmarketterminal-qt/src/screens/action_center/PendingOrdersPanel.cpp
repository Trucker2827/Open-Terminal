...
using openmarketterminal::trading::ActionCenter;
using openmarketterminal::trading::PendingOrder;
...
void PendingOrdersPanel::build_ui() {
    ...
    setStyleSheet(QString(
        ...
        .arg(openmarketterminal::ui::colors::DARK(), openmarketterminal::ui::colors::PANEL(),
             openmarketterminal::ui::colors::BORDER(), openmarketterminal::ui::colors::AMBER(),
             openmarketterminal::ui::colors::TEXT_SECONDARY(), openmarketterminal::ui::colors::TEXT_PRIMARY(),
             openmarketterminal::ui::colors::POSITIVE(), openmarketterminal::ui::colors::NEGATIVE()));
...
void PendingOrdersPanel::refresh() {
    ...
    for (int row = 0; row < orders.size(); ++row) {
        ...
        side_item->setForeground(actUp == "BUY"   ? QColor(openmarketterminal::ui::colors::POSITIVE())
                                 : actUp == "SELL" ? QColor(openmarketterminal::ui::colors::NEGATIVE())
                                                   : QColor(openmarketterminal::ui::colors::TEXT_PRIMARY()));
        ...
        status_item->setForeground(o.status == "approved" ? QColor(openmarketterminal::ui::colors::POSITIVE())
                                   : o.status == "rejected" ? QColor(openmarketterminal::ui::colors::NEGATIVE())
                                                            : QColor(openmarketterminal::ui::colors::AMBER()));
