...
class RelationshipMapScreen : public QWidget, public IStatefulScreen {
  ...
  private:
    ...
    void on_asset_results(const QList<openmarketterminal::services::MarketSearchService::Item>& results);
    void show_dropdown();
    void hide_dropdown();
    void on_data_ready(const openmarketterminal::relmap::RelationshipData& data);
