...
namespace openmarketterminal::screens::maritime_internal {

// Token → QString — works for both ColorToken and FontFamilyToken.
inline QString C(const openmarketterminal::ui::ColorToken& t) {
    return QString::fromLatin1(t.get());
}
inline QString F(const openmarketterminal::ui::fonts::FontFamilyToken& t) {
    return QString::fromLatin1(t.get());
}
...
inline QString table_ss() {
    ...
    return QString("QTableWidget { background:%1; color:%2; gridline-color:%3;"
        ...
        .arg(C(openmarketterminal::ui::colors::BG_BASE), C(openmarketterminal::ui::colors::TEXT_PRIMARY),
             C(openmarketterminal::ui::colors::BG_RAISED), F(openmarketterminal::ui::fonts::DATA_FAMILY))
        .arg(openmarketterminal::ui::fonts::SMALL)
        .arg(C(openmarketterminal::ui::colors::BG_HOVER), C(openmarketterminal::ui::colors::AMBER),
             C(openmarketterminal::ui::colors::ROW_ALT), C(openmarketterminal::ui::colors::BG_RAISED),
             C(openmarketterminal::ui::colors::TEXT_SECONDARY), C(openmarketterminal::ui::colors::BORDER_MED));
}
...
inline QString combo_ss() {
    return QString("QComboBox { background:%1; color:%2; border:1px solid %3; border-radius:2px;"
        ...
        .arg(C(openmarketterminal::ui::colors::BG_RAISED), C(openmarketterminal::ui::colors::TEXT_PRIMARY),
             C(openmarketterminal::ui::colors::BORDER_MED), F(openmarketterminal::ui::fonts::DATA_FAMILY))
        .arg(openmarketterminal::ui::fonts::SMALL)
        .arg(C(openmarketterminal::ui::colors::AMBER), C(openmarketterminal::ui::colors::BG_HOVER));
}
...
inline QString input_ss() {
    return QString("QLineEdit, QDoubleSpinBox { background:%1; color:%2; border:1px solid %3;"
        ...
        .arg(C(openmarketterminal::ui::colors::BG_SURFACE), C(openmarketterminal::ui::colors::TEXT_PRIMARY),
             C(openmarketterminal::ui::colors::BORDER_MED), F(openmarketterminal::ui::fonts::DATA_FAMILY))
        .arg(openmarketterminal::ui::fonts::SMALL)
        .arg(C(openmarketterminal::ui::colors::AMBER));
}
...
inline QString btn_primary_ss() {
    return QString("QPushButton { background:%1; color:%2; font-family:%3; font-size:%4px;"
        ...
        .arg(C(openmarketterminal::ui::colors::AMBER), C(openmarketterminal::ui::colors::BG_BASE), F(openmarketterminal::ui::fonts::DATA_FAMILY))
        .arg(openmarketterminal::ui::fonts::SMALL)
        .arg(C(openmarketterminal::ui::colors::AMBER_DIM));
}
...
inline QString btn_outline_ss() {
    ...
    return QString("QPushButton { background:transparent; color:%1; font-family:%2; font-size:%3px;"
        ...
        .arg(C(openmarketterminal::ui::colors::TEXT_SECONDARY), F(openmarketterminal::ui::fonts::DATA_FAMILY))
        .arg(openmarketterminal::ui::fonts::SMALL)
        .arg(C(openmarketterminal::ui::colors::BORDER_BRIGHT), C(openmarketterminal::ui::colors::BG_HOVER),
             C(openmarketterminal::ui::colors::AMBER));
}
...
inline QString section_label_ss() {
    return QString("color:%1; font-size:12px; font-weight:700; font-family:%2;"
        ...
        .arg(C(openmarketterminal::ui::colors::AMBER), F(openmarketterminal::ui::fonts::DATA_FAMILY),
             C(openmarketterminal::ui::colors::BORDER_DIM));
}
