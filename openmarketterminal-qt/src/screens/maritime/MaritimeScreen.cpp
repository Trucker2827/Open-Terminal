...
void MaritimeScreen::retranslateUi() {
    // Top bar
    if (brand_label_)      brand_label_->setText(tr("OPENMARKETTERMINAL MARITIME INTELLIGENCE"));
    if (classified_label_) classified_label_->setText(tr("VESSEL TRACKING // OPENMARKETTERMINAL MARINE API"));
