...
static const struct {
    ...
    {"bea", "BEA", "#E65100"},
    {"openmarketterminal", "Open Macro", "#d97706"}, // rewired: World Bank + FRED via connectors (was OpenMarketTerminal stub)
};
...
static EconPanelBase* make_panel(const QString& id, QWidget* parent) {
    ...
    if (id == "openmarketterminal")
        return new OpenMarketTerminalMacroPanel(parent);
    return nullptr;
}
