...
EquityChartPanel::EquityChartPanel(QWidget* parent) : QWidget(parent) {
    ...
    kline_ = new openmarketterminal::ui::KLineChartWidget(this);
    if (kline_->is_available()) {
        ...
        connect(kline_, &openmarketterminal::ui::KLineChartWidget::buy_requested, this,
                &EquityChartPanel::buy_requested);
        connect(kline_, &openmarketterminal::ui::KLineChartWidget::sell_requested, this,
                &EquityChartPanel::sell_requested);
        connect(kline_, &openmarketterminal::ui::KLineChartWidget::add_to_watchlist_requested, this,
...
void EquityChartPanel::build_kline_ui() {
    ...
    bar->setStyleSheet(QString("background:%1;").arg(openmarketterminal::ui::colors::BG_SURFACE()));
    ...
    const QString inactive =
        QString("QPushButton{background:transparent;color:%1;border:1px solid %2;"
            ...
            .arg(openmarketterminal::ui::colors::TEXT_SECONDARY(), openmarketterminal::ui::colors::BORDER_DIM(),
                 openmarketterminal::ui::colors::AMBER(), openmarketterminal::ui::colors::TEXT_PRIMARY());
    const QString active =
        QString("QPushButton{background:%1;color:%2;border:1px solid %1;border-radius:2px;"
            ...
            .arg(openmarketterminal::ui::colors::AMBER(), openmarketterminal::ui::colors::BG_BASE());
...
void EquityChartPanel::build_position_card() {
    namespace c = openmarketterminal::ui::colors;
    namespace f = openmarketterminal::ui::fonts;
...
void EquityChartPanel::draw_position_line() {
    if (!has_position_)
        return;
    const bool is_long = (pos_side_ != QLatin1String("short"));
    const QString hex = is_long ? QString(openmarketterminal::ui::colors::POSITIVE())
                                : QString(openmarketterminal::ui::colors::NEGATIVE());
