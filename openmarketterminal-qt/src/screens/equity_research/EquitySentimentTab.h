...
class EquitySentimentTab : public QWidget {
  ...
  private slots:
    void on_sentiment_loaded(QString symbol, openmarketterminal::services::equity::EquitySentimentSnapshot snapshot);

  private:
    void build_ui();
    void retranslateUi();
    void populate(const openmarketterminal::services::equity::EquitySentimentSnapshot& snapshot);
    ...
    openmarketterminal::services::equity::EquitySentimentSnapshot cached_snapshot_;
