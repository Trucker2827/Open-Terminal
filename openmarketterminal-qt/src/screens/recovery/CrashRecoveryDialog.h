...
class CrashRecoveryDialog : public QDialog {
  ...
  public:
    ...
    explicit CrashRecoveryDialog(openmarketterminal::CrashRecovery* recovery,
  ...
  private:
    ...
    QString display_name(const openmarketterminal::WorkspaceSnapshotRing::Entry& e) const;

    openmarketterminal::CrashRecovery* recovery_ = nullptr;
    openmarketterminal::WorkspaceSnapshotRing* ring_ = nullptr;
    ...
    QList<openmarketterminal::WorkspaceSnapshotRing::Entry> entries_;
