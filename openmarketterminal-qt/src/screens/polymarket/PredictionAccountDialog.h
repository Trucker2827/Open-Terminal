...
class PredictionAccountDialog : public QDialog {
  ...
  public:
    ...
    void show_test_running(const QString& exchange_id);
    void show_test_success(const QString& exchange_id, const QString& message);
    void show_test_error(const QString& exchange_id, const QString& message);
  ...
  private:
    ...
    void load_existing();
    void retranslateUi();
    bool load_kalshi_secret_file(const QString& path);
