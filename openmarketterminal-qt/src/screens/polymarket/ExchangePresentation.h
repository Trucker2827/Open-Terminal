...
struct ExchangePresentation {
    ...
    StatusBadge status_badge(const openmarketterminal::services::prediction::PredictionMarket& market) const;

    // Factories.
    static ExchangePresentation for_polymarket();
    static ExchangePresentation for_kalshi();
    static ExchangePresentation for_adapter(const openmarketterminal::services::prediction::PredictionExchangeAdapter* adapter);
