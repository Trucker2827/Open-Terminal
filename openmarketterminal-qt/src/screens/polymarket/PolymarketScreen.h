...
class PolymarketScreen : public QWidget, public openmarketterminal::screens::IStatefulScreen {
    Q_OBJECT
  public:
  ...
  private slots:
    ...
    // Browse panel
    void on_market_selected(const openmarketterminal::services::prediction::PredictionMarket& market);
    void on_event_selected(const openmarketterminal::services::prediction::PredictionEvent& event);

    // Detail panel
    void on_interval_changed(const QString& interval);
    void on_outcome_changed(int index);
    void on_related_market_clicked(const openmarketterminal::services::prediction::PredictionMarket& market);
    ...
    void on_search_results_ready(const QVector<openmarketterminal::services::prediction::PredictionMarket>& markets,
                                 const QVector<openmarketterminal::services::prediction::PredictionEvent>& events);
    void on_tags_ready(const QStringList& tags);
    void on_order_book_ready(const openmarketterminal::services::prediction::PredictionOrderBook& book);
    void on_price_history_ready(const openmarketterminal::services::prediction::PriceHistory& history);
    void on_trades_ready(const QVector<openmarketterminal::services::prediction::PredictionTrade>& trades);
    ...
    void on_price_summary_received(const openmarketterminal::services::polymarket::PriceSummary& summary);
    void on_top_holders_received(const QVector<openmarketterminal::services::polymarket::TopHolder>& holders);
    void on_comments_received(const QVector<openmarketterminal::services::polymarket::Comment>& comments);
    void on_related_markets_received(const QVector<openmarketterminal::services::polymarket::Market>& markets);
    ...
    void on_kalshi_ws_trade(const openmarketterminal::services::prediction::PredictionTrade& trade);
    ...
    void on_kalshi_market_detail(const openmarketterminal::services::prediction::PredictionMarket& market);
    void on_kalshi_series_detail(const QString& series_ticker, const QJsonObject& series);

    // Open-orders blotter.
    void on_open_orders_ready(const QVector<openmarketterminal::services::prediction::OpenOrder>& orders);
  ...
  private:
    ...
    QHash<QString, openmarketterminal::services::prediction::PriceHistory> batch_candles_cache_;
};
