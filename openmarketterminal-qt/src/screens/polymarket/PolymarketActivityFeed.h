...
class PolymarketActivityFeed : public QWidget {
  ...
  public:
    ...
    void append_trade(const openmarketterminal::services::prediction::PredictionTrade& trade);
    void clear();
  ...
  private:
    ...
    // decimal places.
    QVector<openmarketterminal::services::prediction::PredictionTrade> last_trades_;
};
