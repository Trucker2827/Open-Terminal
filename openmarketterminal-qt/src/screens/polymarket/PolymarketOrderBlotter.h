...
class PolymarketOrderBlotter : public QWidget {
  ...
  public:
    ...
    void set_orders(const QVector<openmarketterminal::services::prediction::OpenOrder>& orders);
    ...
    void update_order(const openmarketterminal::services::prediction::OpenOrder& order);
    void clear();
  ...
  private:
    void rebuild_rows();
    void install_row_controls(int row, const openmarketterminal::services::prediction::OpenOrder& order);
    void retranslateUi();

    QLabel* title_label_ = nullptr;
    QPushButton* cancel_all_btn_ = nullptr;
    QTableWidget* table_ = nullptr;
    QVector<openmarketterminal::services::prediction::OpenOrder> orders_;
