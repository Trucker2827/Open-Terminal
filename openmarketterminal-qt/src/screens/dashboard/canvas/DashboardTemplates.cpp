...
QVector<DashboardTemplate> all_dashboard_templates() {
    return {
        ...
        // ── Portfolio Manager ────────────────────────────────────────────────
        {"portfolio_manager",
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Portfolio Manager"),
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Holdings, performance, risk and watchlist"),
         {
             ...
             gi("dinero_network", 0, 13, 4, 6, 2, 4),
         }},

        // ── Hedge Fund ────────────────────────────────────────────────────────
        {"hedge_fund",
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Hedge Fund"),
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Sector heatmap, screener, risk and macro"),
         {
        ...
        // ── Equity Trader ─────────────────────────────────────────────────────
        {"equity_trader",
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Equity Trader"),
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Indices, forex, commodities, screener and movers"),
         {
             gi("indices", 0, 0, 4, 5, 3, 4),
             gi("forex", 4, 0, 4, 4),
        ...
        // ── Macro Economist ───────────────────────────────────────────────────
        {"macro_economist",
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Macro Economist"),
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Economic calendar, indices, commodities and news"),
         {
        ...
        // ── Geopolitics Analyst ───────────────────────────────────────────────
        {"geopolitics",
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "Geopolitics Analyst"),
         QT_TRANSLATE_NOOP("openmarketterminal::screens::DashboardTemplates", "News, sentiment, economic calendar and screener"),
         {
             gi("news", 0, 0, 8, 5),
...
QString template_display_name_tr(const DashboardTemplate& t) {
    return QCoreApplication::translate("openmarketterminal::screens::DashboardTemplates",
