...
class AiChatScreen : public QWidget, public IStatefulScreen, public openmarketterminal::IGroupLinked {
    Q_OBJECT
  ...
  public:
    ...
    void set_group(openmarketterminal::SymbolGroup g) override;
    ...
    openmarketterminal::SymbolRef current_symbol() const override { return linked_symbol_; }
  ...
  private:
    ...
    openmarketterminal::SymbolRef linked_symbol_;
};
