...
class AlertsPanel : public QWidget {
  ...
  private:
    ...
    openmarketterminal::ui::algo::ConditionSection* section_ = nullptr;
    ...
    void load_watch(const openmarketterminal::ScanWatch& w); // load an existing watch into the form for editing
};
