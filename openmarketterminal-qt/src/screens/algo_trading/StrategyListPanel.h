...
class StrategyListPanel : public QWidget {
  ...
  signals:
    void edit_requested(openmarketterminal::services::algo::AlgoStrategy strategy);
    void backtest_requested(openmarketterminal::services::algo::AlgoStrategy strategy, QString symbol,
                            QString start_date, QString end_date);

  private slots:
    void on_strategies_loaded(QVector<openmarketterminal::services::algo::AlgoStrategy> strategies);
  ...
  private:
    ...
    QVector<openmarketterminal::services::algo::AlgoStrategy> strategies_;  // full list
    QVector<openmarketterminal::services::algo::AlgoStrategy> filtered_;    // after search/sort
