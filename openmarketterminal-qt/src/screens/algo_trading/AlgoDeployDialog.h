...
class AlgoDeployDialog : public QDialog {
  ...
  public:
    ...
    explicit AlgoDeployDialog(const openmarketterminal::services::algo::AlgoStrategy& strategy, QWidget* parent = nullptr);

    openmarketterminal::services::algo::AlgoDeployment result() const;
    openmarketterminal::services::algo::AlgoDeployment deployment() const { return result_; }
  ...
  private:
    ...
    openmarketterminal::services::algo::AlgoDeployment result_;
};
