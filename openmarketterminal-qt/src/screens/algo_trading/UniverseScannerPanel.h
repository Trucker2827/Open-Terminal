...
class UniverseScannerPanel : public QWidget {
  ...
  private:
    ...
    bool current_strategy(openmarketterminal::services::algo::AlgoStrategy* out) const;

    QComboBox*    strategy_combo_  = nullptr;
    QComboBox*    universe_combo_  = nullptr;
    openmarketterminal::ui::algo::SymbolChipInput* symbols_input_ = nullptr;
    ...
    QVector<openmarketterminal::services::algo::AlgoStrategy> strategies_;
