...
using openmarketterminal::services::AnalyticsResult;
using openmarketterminal::services::PortfolioAnalyticsService;
...
QWidget* PortfolioOptimizationView::build_backtest_tab() {
    ...
    auto run_inline_backtest = [this](const QJsonArray& symbols, const QJsonArray& weights) {
        ...
        auto& svc = openmarketterminal::services::backtest::BacktestingService::instance();
    ...
    auto& svc = openmarketterminal::services::backtest::BacktestingService::instance();
    connect(&svc, &openmarketterminal::services::backtest::BacktestingService::result_ready, this,
    ...
    connect(&svc, &openmarketterminal::services::backtest::BacktestingService::error_occurred, this,
