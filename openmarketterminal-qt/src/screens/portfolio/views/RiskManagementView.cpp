...
static const StressScenario kScenarios[] = {
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "2008 Financial Crisis"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Lehman collapse, credit freeze"), -38.5, 5.2, -33.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "2020 COVID Crash"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Pandemic selloff (Feb-Mar 2020)"), -33.9, 1.2, -20.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Dot-com Bust"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Tech bubble burst (2000-2002)"), -49.1, 8.5, -10.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Interest Rate Shock +3%"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Aggressive Fed tightening"), -15.0, -12.0, -5.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Black Monday 1987"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Single-day market crash"), -22.6, 2.0, -8.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Inflation Surge"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "1970s-style stagflation"), -10.0, -15.0, 25.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Geopolitical Crisis"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Major conflict escalation"), -12.0, 3.0, 15.0},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Currency Crisis"),
     QT_TRANSLATE_NOOP("openmarketterminal::screens::RiskManagementView", "Emerging market contagion"), -18.0, 1.0, 5.0},
};
