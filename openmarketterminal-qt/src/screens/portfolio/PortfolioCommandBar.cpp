...
static const DetailBtnDef kDetailButtons[] = {
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "SECTORS"), portfolio::DetailView::AnalyticsSectors},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "PERF/RISK"), portfolio::DetailView::PerfRisk},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "OPTIMIZE"), portfolio::DetailView::Optimization},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "QUANTSTATS"), portfolio::DetailView::QuantStats},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "REPORTS"), portfolio::DetailView::ReportsPme},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "INDICES"), portfolio::DetailView::Indices},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "RISK"), portfolio::DetailView::RiskMgmt},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "PLANNING"), portfolio::DetailView::Planning},
    {QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioCommandBar", "ECONOMICS"), portfolio::DetailView::Economics},
};
