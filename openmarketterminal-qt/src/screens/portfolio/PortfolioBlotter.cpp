...
static const char* const kColumnKeys[] = {
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "SYMBOL"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "QTY"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "LAST"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "AVG COST"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "MKT VAL"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "COST BASIS"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "P&L"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "P&L%"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "CHG%"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "TREND"),
    QT_TRANSLATE_NOOP("openmarketterminal::screens::PortfolioBlotter", "WT%"),
};
