...
static constexpr ViewMeta kViews[] = {
    {services::AgentViewMode::Agents,    QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "AGENTS")},
    {services::AgentViewMode::Create,    QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "CREATE")},
    {services::AgentViewMode::Teams,     QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "TEAMS")},
    {services::AgentViewMode::Workflows, QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "WORKFLOWS")},
    {services::AgentViewMode::Planner,   QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "PLANNER")},
    {services::AgentViewMode::Tools,     QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "TOOLS")},
    {services::AgentViewMode::Chat,      QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "CHAT")},
    {services::AgentViewMode::System,    QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "SYSTEM")},
    {services::AgentViewMode::Agentic,   QT_TRANSLATE_NOOP("openmarketterminal::screens::AgentConfigScreen", "AGENTIC")},
};
...
AgentConfigScreen::AgentConfigScreen(QWidget* parent) : QWidget(parent) {
    ...
    connect(&openmarketterminal::EventBus::instance(), &openmarketterminal::EventBus::eventPublished, this,
