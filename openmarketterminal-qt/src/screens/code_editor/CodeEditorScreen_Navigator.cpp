...
// "# 📘 OpenMarketTerminal Notebook — Time Value of Money" shows as
// "OpenMarketTerminal Notebook — Time Value of Money" and "# Setup" shows as "Setup".
...
void CellNavigator::rebuild(const QVector<NotebookCell>& cells, const QString& selected_id) {
    ...
    for (int i = 0; i < cells.size(); ++i) {
        ...
        // " 1  PY  OpenMarketTerminal Notebook — Time Value of Money   [3]"
