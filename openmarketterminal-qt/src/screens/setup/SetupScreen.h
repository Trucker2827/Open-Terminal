...
namespace openmarketterminal::net {
class NetSpeedMeter;
}
...
class SetupScreen : public QWidget {
  ...
  private slots:
    void on_begin_setup();
    void on_progress(const openmarketterminal::python::SetupProgress& progress);
  ...
  private:
    ...
    QLabel* title_lbl_ = nullptr;       // OPENMARKETTERMINAL — brand, not translated
    ...
    openmarketterminal::ui::SpeedSparkline* sparkline_ = nullptr;
    openmarketterminal::net::NetSpeedMeter* net_meter_ = nullptr;
