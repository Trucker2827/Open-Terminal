...
Q_DECLARE_METATYPE(openmarketterminal::services::HistoryPoint)
Q_DECLARE_METATYPE(openmarketterminal::services::InfoData)
Q_DECLARE_METATYPE(QVector<openmarketterminal::services::HistoryPoint>)
Q_DECLARE_METATYPE(openmarketterminal::trading::TickerData)
Q_DECLARE_METATYPE(openmarketterminal::trading::OrderBookData)
Q_DECLARE_METATYPE(openmarketterminal::trading::Candle)
Q_DECLARE_METATYPE(openmarketterminal::trading::TradeData)
