...
static ToolResult run_ma_sync(const QString& context, std::function<void()> trigger) {
    ...
    auto& svc = openmarketterminal::services::ma::MAAnalyticsService::instance();

    detail::run_async_wait(&svc, [&](auto signal_done) {
        auto* gate = new QObject;
        QObject::connect(&svc, &openmarketterminal::services::ma::MAAnalyticsService::result_ready, gate,
        ...
        QObject::connect(&svc, &openmarketterminal::services::ma::MAAnalyticsService::error_occurred, gate,
...
std::vector<ToolDef> get_ma_analytics_tools() {
    ...
    // ── ma_dcf ──────────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("dcf",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_dcf(args); });
        };
    ...
    // ── ma_dcf_sensitivity ──────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("dcf_sensitivity", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_dcf_sensitivity(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_lbo_returns ──────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("lbo_returns", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_lbo_returns(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_lbo_model ────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("lbo_model",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().build_lbo_model(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_lbo_debt_schedule ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("lbo_debt_schedule", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_lbo_debt_schedule(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_lbo_sensitivity ──────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("lbo_sensitivity", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_lbo_sensitivity(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_trading_comps ────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("trading_comps", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_trading_comps(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_precedent_transactions ───────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("precedent_transactions", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_precedent_transactions(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_football_field ───────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("football_field", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().generate_football_field(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_merger_model ─────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("merger_model", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().build_merger_model(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_accretion_dilution ───────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("accretion_dilution", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_accretion_dilution(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_pro_forma ────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("pro_forma",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().build_pro_forma(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_sources_uses ─────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("sources_uses", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_sources_uses(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_contribution_analysis ────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("contribution_analysis", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_contribution(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_revenue_synergies ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("revenue_synergies", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_revenue_synergies(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_cost_synergies ───────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("cost_synergies", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_cost_synergies(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_synergies_dcf ────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("synergies_dcf", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().value_synergies_dcf(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_integration_costs ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("integration_costs", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().estimate_integration_costs(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_payment_structure ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("payment_structure", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_payment_structure(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_earnout ──────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("earnout",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().value_earnout(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_exchange_ratio ───────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("exchange_ratio", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_exchange_ratio(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_collar_mechanism ─────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("collar_mechanism", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_collar_mechanism(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_cvr ──────────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("cvr", [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().value_cvr(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_get_deals ────────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject&) -> ToolResult {
            return run_ma_sync("get_all_deals",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().get_all_deals(); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_search_deals ─────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            ...
            return run_ma_sync("search_deals",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().search_deals(query); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_create_deal ──────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("create_deal",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().create_deal(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_update_deal ──────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            ...
            return run_ma_sync("update_deal", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().update_deal(deal_id, updates);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_berkus ───────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("berkus",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_berkus(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_vc ───────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("vc_method", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_vc_method(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_scorecard ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("scorecard", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_scorecard(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_first_chicago ────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("first_chicago", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_first_chicago(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_risk_factor ──────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("risk_factor", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_risk_factor(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_startup_comprehensive ────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("comprehensive_startup", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_comprehensive_startup(
    ...
    // ── ma_fairness_opinion ─────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("fairness_opinion", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().generate_fairness_opinion(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_premium_analysis ─────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("premium_analysis",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_premium(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_process_quality ──────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("process_quality", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().assess_process_quality(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_tech_metrics ─────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("tech_metrics", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_tech_metrics(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_healthcare_metrics ───────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("healthcare_metrics", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_healthcare_metrics(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_financial_metrics ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("financial_services_metrics", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().calculate_financial_services_metrics(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_monte_carlo ──────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("monte_carlo",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().run_monte_carlo(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_regression ───────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("regression",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().run_regression(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_compare_deals ────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("compare_deals",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().compare_deals(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_rank_deals ───────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("rank_deals",
                               [&]() { openmarketterminal::services::ma::MAAnalyticsService::instance().rank_deals(args); });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_benchmark_premium ────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("benchmark_premium", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().benchmark_deal_premium(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_payment_structures_analysis ─────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("payment_structures_analysis", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_payment_structures(args);
            });
        };
        tools.push_back(std::move(t));
    }
    ...
    // ── ma_industry_deals ───────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject& args) -> ToolResult {
            return run_ma_sync("industry_deals", [&]() {
                openmarketterminal::services::ma::MAAnalyticsService::instance().analyze_industry_deals(args);
            });
        };
        tools.push_back(std::move(t));
    }
