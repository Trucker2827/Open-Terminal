...
// OPENMARKETTERMINAL_VERSION_STRING is injected by CMake from CMAKE_PROJECT_VERSION.
    ...
    // ── get_app_info ───────────────────────────────────────────────────
    {
        ...
        t.handler = [](const QJsonObject&) -> ToolResult {
            return ToolResult::ok_data(
                QJsonObject{{"version", QString::fromUtf8(OPENMARKETTERMINAL_VERSION_STRING)},
                            {"platform",
#ifdef _WIN32
                             "windows"
