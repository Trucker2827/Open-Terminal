...
// Translated from openmarketterminal-cpp mcp_types.h — std::string → QString, nlohmann::json → QJsonObject
...
struct UnifiedTool {
    QString server_id; // "openmarketterminal" for internal tools
    QString server_name;
    QString name;
    QString description;
    QJsonObject input_schema;
...
inline constexpr const char* INTERNAL_SERVER_ID = "openmarketterminal";
inline constexpr const char* INTERNAL_SERVER_NAME = "OpenMarketTerminal";
