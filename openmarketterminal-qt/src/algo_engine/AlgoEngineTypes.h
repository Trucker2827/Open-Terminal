...
Q_DECLARE_METATYPE(openmarketterminal::algo::AlgoMetrics)
Q_DECLARE_METATYPE(openmarketterminal::algo::AlgoTradeRecord)
Q_DECLARE_METATYPE(openmarketterminal::algo::OhlcvCandle)
Q_DECLARE_METATYPE(openmarketterminal::algo::AlgoConditionStatus)
Q_DECLARE_METATYPE(openmarketterminal::algo::AlgoLiveSnapshot)
