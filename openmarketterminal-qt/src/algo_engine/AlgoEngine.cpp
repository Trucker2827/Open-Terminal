...
AlgoEngine::AlgoEngine() {
    ...
    qRegisterMetaType<openmarketterminal::algo::AlgoLiveSnapshot>("openmarketterminal::algo::AlgoLiveSnapshot");
    qRegisterMetaType<openmarketterminal::algo::AlgoMetrics>("openmarketterminal::algo::AlgoMetrics");
    qRegisterMetaType<openmarketterminal::algo::AlgoTradeRecord>("openmarketterminal::algo::AlgoTradeRecord");
...
void AlgoEngine::execute_order(const AlgoOrderSignal& signal) {
    ...
    openmarketterminal::trading::UnifiedOrder order;
    ...
    (void)QtConcurrent::run([self, dep_id, account_id, order, submitted_price]() {
        auto response = openmarketterminal::trading::UnifiedTrading::instance()
...
void AlgoEngine::persist_deployment(const services::algo::AlgoDeployment& d) {
    auto db = openmarketterminal::Database::instance().connection();
    QSqlQuery q(db);
