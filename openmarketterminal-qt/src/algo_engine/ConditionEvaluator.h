...
public:
    static ConditionResult evaluate_single(
        const openmarketterminal::services::algo::ConditionDef& condition,
...
private:
    static openmarketterminal::services::algo::ConditionDef parse_condition(const QJsonObject& obj);
