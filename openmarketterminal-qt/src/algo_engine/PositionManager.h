...
public:
    ...
    void record_entry_legs(const QVector<openmarketterminal::algo::AlgoLegPosition>& legs, int64_t time_ms);
    ...
    QVector<openmarketterminal::algo::AlgoLegPosition> legs() const;      // mutex copy
...
private:
    ...
    QVector<openmarketterminal::algo::AlgoLegPosition> legs_;
