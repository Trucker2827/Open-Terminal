...
public:
    ...
    void start_deployment(const openmarketterminal::services::algo::AlgoDeployment& deployment,
...
signals:
    ...
    void deployments_loaded(QVector<openmarketterminal::services::algo::AlgoDeployment> deployments);
...
private slots:
    void on_order_requested(const openmarketterminal::algo::AlgoOrderSignal& signal);
...
private:
    ...
    void persist_deployment(const openmarketterminal::services::algo::AlgoDeployment& deployment);
    ...
    openmarketterminal::services::algo::AlgoStrategy load_strategy(const QString& strategy_id);
