"""
OpenMarketTerminal - Python Output Standardization Library
=========================================================

This library provides a standard output format for all Python scripts in the OpenMarketTerminal.
...
Usage:
    from openmarketterminal_output_standard import standardize_output, OutputType
...
class OpenMarketTerminalOutputStandardizer:
...
def standardize_output(data: Any,
    ...
    """
    standardizer = OpenMarketTerminalOutputStandardizer(script_name, include_metadata)
...
def wrap_script_execution(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        standardizer = OpenMarketTerminalOutputStandardizer(script_name)
        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    ...
                    "timestamp": datetime.utcnow().isoformat() + "Z",
                    "output_type": OutputType.ERROR.value,
                    "version": OpenMarketTerminalOutputStandardizer.VERSION
                }
            }
