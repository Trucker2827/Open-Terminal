...
# Database path: Use OpenMarketTerminal_DATA_DIR env var if set, otherwise fall back to user data dir
def get_database_dir() -> Path:
    ...
    if data_dir := os.environ.get("OpenMarketTerminal_DATA_DIR"):
    ...
    return base / "openmarketterminal-dev"
