...
class OpenMarketTerminalAnalyticsError(Exception):
    """Base exception for analytics module"""
    pass


class DataProviderError(OpenMarketTerminalAnalyticsError):
    """Exception for data provider issues"""
    pass


class ValidationError(OpenMarketTerminalAnalyticsError):
    """Exception for input validation failures"""
    pass


class CalculationError(OpenMarketTerminalAnalyticsError):
    """Exception for calculation failures"""
    pass


class ModelError(OpenMarketTerminalAnalyticsError):
