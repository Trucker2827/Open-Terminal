...
class DatabaseManager:
    def __init__(self, db_path: Optional[str] = None):
        ...
        if db_path is None:
            # Use OpenMarketTerminal_DATA_DIR env var if set by host, otherwise use platform-specific app data
            data_dir = os.environ.get("OpenMarketTerminal_DATA_DIR")
            if data_dir:
                ...
                db_dir = os.path.join(base, 'openmarketterminal-dev', 'alpha_arena')
