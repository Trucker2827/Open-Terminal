...
Environment variables (set by DeepgramTtsProvider in C++):
    ...
    OpenMarketTerminal_TTS_DG_MODEL  default "aura-2-thalia-en"
    OpenMarketTerminal_TTS_RATE      pyttsx3 leftover, ignored here
"""
...
def main() -> int:
    ...
    model = os.environ.get("OpenMarketTerminal_TTS_DG_MODEL", "aura-2-thalia-en").strip() \
            or "aura-2-thalia-en"
