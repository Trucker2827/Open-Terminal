...
`%LOCALAPPDATA%/org.openmarketterminal.OpenMarketTerminal/finagent` on Windows and
`$XDG_DATA_HOME/org.openmarketterminal.OpenMarketTerminal/finagent` (or `~/.local/share/...`)
elsewhere.
