"""
TerminalToolkit - Agno Toolkit that proxies calls to OpenMarketTerminal internal MCP tools.
...
class TerminalToolkit:
    """
    Agno-compatible toolkit that wraps OpenMarketTerminal's internal MCP tools.
