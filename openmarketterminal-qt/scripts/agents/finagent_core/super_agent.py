...
class SuperAgent:
    ...
    def _resolve_model_config_from_keys(self, api_keys: Dict[str, Any]) -> Dict[str, Any]:
        ...
        keys = api_keys or {}
        preferred = ["openmarketterminal", "ollama", "anthropic", "google", "groq",
    ...
    def execute(
        ...
        try:
            ...
            _ERROR_PREFIXES = (
                "OpenMarketTerminal API error",
                "OpenMarketTerminal API request timed out",
                "OpenMarketTerminal API failed",
                "Cannot connect to OpenMarketTerminal API",
            )
