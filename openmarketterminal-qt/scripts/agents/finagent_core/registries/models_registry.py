...
class ModelsRegistry:
    ...
    MODEL_CATALOG = {
        ...
        # OpenMarketTerminal (Built-in custom endpoint)
        "openmarketterminal": {
            "class": "finagent_core.registries.openmarketterminal_model.OpenMarketTerminalChat",
            "models": ["openmarketterminal-llm"],
            "api_key_env": "OpenMarketTerminal_API_KEY",
            "default_model": "openmarketterminal-llm",
            "base_url": "https://api.example.com/research/llm",
        },
    }
