"""
subagents.py — SubAgent definitions for OpenMarketTerminal Deep Agents.
...
RESEARCH_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial research specialist for OpenMarketTerminal. "
...
DATA_ANALYST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a quantitative data analyst for OpenMarketTerminal. "
...
TRADING_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a trading strategy specialist for OpenMarketTerminal. "
...
RISK_ANALYZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a risk management specialist for OpenMarketTerminal. "
...
PORTFOLIO_OPTIMIZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a portfolio optimization specialist for OpenMarketTerminal. "
...
BACKTESTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a backtesting specialist for OpenMarketTerminal. "
...
REPORTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial report writer for OpenMarketTerminal. "
...
MACRO_ECONOMIST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a macroeconomic analyst for OpenMarketTerminal. "
