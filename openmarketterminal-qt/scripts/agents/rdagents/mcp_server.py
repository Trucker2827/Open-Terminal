"""
mcp_server.py — OpenMarketTerminal MCP HTTP server for RD-Agent tool use.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="OpenMarketTerminal MCP server for RD-Agent")
    ...
    print(f"OpenMarketTerminal MCP server starting on http://{args.host}:{args.port}/mcp", flush=True)
