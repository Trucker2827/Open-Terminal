...
def _make_request(endpoint: str, params: Dict = None) -> Any:
    ...
    try:
        headers = {"User-Agent": "Mozilla/5.0 (compatible; OpenMarketTerminal/0.1.0)"}
...
def _fetch_multpl_series(series_id: str, start_year: int = None, end_year: int = None) -> Any:
    ...
    try:
        headers = {"User-Agent": "Mozilla/5.0 (compatible; OpenMarketTerminal/0.1.0)", "Accept": "application/json"}
