...
# ── Persistence paths ─────────────────────────────────────────────────────────
OpenMarketTerminal_DIR = Path.home() / ".openmarketterminal"
SCHEDULES_FILE = OpenMarketTerminal_DIR / "rolling_schedules.json"
CONFIGS_DIR = OpenMarketTerminal_DIR / "configs"
...
def save_schedules(schedules: Dict[str, Any]):
    OpenMarketTerminal_DIR.mkdir(parents=True, exist_ok=True)
