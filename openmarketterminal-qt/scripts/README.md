...
> Comprehensive collection of data sources, analytics, and AI agents for OpenMarketTerminal

## Overview

This directory contains Python scripts powering the backend analytics, data integrations, and AI capabilities of OpenMarketTerminal. All scripts are executed by the C++ application via the Python bridge (python_runner.cpp).
...
Part of **OpenMarketTerminal** - a financial intelligence platform built with:
- **UI**: C++20 + Qt6 Widgets
- **Core**: C++20
...
MIT License - Part of OpenMarketTerminal
